```mermaid
graph TD
    %% IBM Planning Analytics Chatbot Architecture (AWS + IBM Cloud)
    ...
    subgraph AI_and_Logic_Layer_AWS
        C1[Intent Recognition and Orchestration - Lambda and Bedrock]
    ...
    subgraph Integration_Layer
        ...
        D3[Data Access Policy Layer - Row or Column Security]
    end

    subgraph Data_and_Governance_Layer
        E1[Metadata Catalog - AWS Glue and Alation]
    ...
    subgraph Monitoring_and_FinOps
        F1[Cost Tracking Dashboard - Cost Explorer and QuickSight]
